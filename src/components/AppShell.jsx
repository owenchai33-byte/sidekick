...
// Agent-first: the WhatsApp agent does the posting, so the app is just its
// dashboard. Two screens — the auto-post Feed and Settings (connect + brand).
// Manual tools (Create, Inbox, Content, Listings, Dashboard) still exist as
// routes and are reachable from Settings, but they're off the main nav.
const NAV = [
  { to: '/', label: 'Feed', icon: 'M4 5h16M4 12h16M4 19h10', end: true, primary: true },
